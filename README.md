...
A repository of BOEM Wind Energy Areas (WEAs) in simple features [`sf`](https://r-spatial.github.io/sf/) format stored in an *.rda file for use with [`R`](https://www.r-project.org/). Also includes locations of offshore wind turbines from the [USGS US Wind Turbine Database](https://eerscmap.usgs.gov/uswtdb/).

...
A repository of BOEM Wind Energy Areas (WEAs) in simple features [`sf`](https://r-spatial.github.io/sf/) format stored in an *.rda file for use with [`R`](https://www.r-project.org/). For more information, click [here](jmhatch-noaa.github.io/boemWind/).

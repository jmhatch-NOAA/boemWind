...
#' @details
#' BOEM wind lease area outlines were updated on 12/Lease/Outlines (version 11) and BOEM wind planning area outlines were updated on Outlines/Planning/Area (version ).
#'

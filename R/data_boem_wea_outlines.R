...
#'
#' @format A \code{sf} collection with 53 features and 23 fields.
#' \describe{
#'   \item{Geometry type}{MULTIPOLYGON}
#'   \item{Dimension}{XY}
#'   \item{Bounding box}{xmin: -158.6636 ymin: 20.7765 xmax: -70.0215 ymax: 43.9597}
...
#' @details
#' BOEM wind lease area outlines were updated on 2022/6/30 (version 10.81) and BOEM wind planning area outlines were updated on 2022/6/1 (version 10.81).
#'
